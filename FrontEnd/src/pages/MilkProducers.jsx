        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-700 mb-6">
              Dairy plant produces Sterilized Flavoured Milk, Curd, Paneer like
              Shrikhand, Amrakhand, Pedha, Khoa, Basundi, Lassi, Taak, Spicy
              Chaas. BUTTER & GHEE in large quantities is also produced for the
              National market.
            </p>
